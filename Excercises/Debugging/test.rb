...
# Remove spaces, special chars, and downcase

# size of square decided by length of the message
# If message is a perfect square length, use that many columns.
# ie. 81 chars => 9 columns, 9 chars in each
# If not a perfect square, choose a number of columns that corresponds
# to the smallest square that is larger than the number of chars.
# ie. 78 chars => 9 columns, 9 chars in each, but only 6 in the last one
